...
getValidators();`,
      ...
      slides: [
        {
          title: { es: "¿Qué es el consenso?", en: "What is consensus?", jp: "コンセンサスとは？", ko: "합의란 무엇인가?" },
          content: {
        ...
        {
          title: { es: "PoW vs PoS vs Federated", en: "PoW vs PoS vs Federated", jp: "PoW vs PoS vs 連合型コンセンサス", ko: "PoW vs PoS vs 연합 합의" },
          content: {
        ...
        {
          title: { es: "¿Por qué consenso federado?", en: "Why federated consensus?", jp: "なぜ連合型コンセンサスなのか？", ko: "왜 연합 합의인가?" },
          content: {
...
monitorLedgers();`,
      ...
      slides: [
        {
          title: { es: "UNL: Unique Node List", en: "UNL: Unique Node List", jp: "UNL：ユニークノードリスト", ko: "UNL: 고유 노드 목록" },
          content: {
        ...
        {
          title: { es: "Propiedades del consenso", en: "Consensus properties", jp: "コンセンサスの特性", ko: "합의 특성" },
          content: {
        ...
        {
          title: { es: "Las 5 fases del consenso", en: "The 5 phases of consensus", jp: "コンセンサスの5つのフェーズ", ko: "합의의 5단계" },
          content: {
...
80% 임계값에 도달하지 못하면 원장은 단순히 **닫히지 않습니다**. 분쟁 중인 트랜잭션은 다음 합의 라운드까지 연기됩니다. "부분적인 승자"는 없습니다. 완전한 합의가 있거나 종결이 없거나 둘 중 하나입니다. 합의에 도달할 수 없으면 블록체인은 오류를 범하기보다 멈춥니다.`,
      ...
      slides: [
        {
          title: { es: "El Problema de los Generales Bizantinos", en: "The Byzantine Generals Problem", jp: "ビザンチン将軍問題", ko: "비잔틴 장군 문제" },
          content: {
        ...
        {
          title: { es: "Xahau y la tolerancia a fallos", en: "Xahau and fault tolerance", jp: "Xahauと障害耐性", ko: "Xahau와 장애 허용" },
          content: {
...
checkNetworkFees();`,
      ...
      slides: [
        {
          title: { es: "¿Quién opera los validadores?", en: "Who operates the validators?", jp: "誰がバリデーターを運営するのか？", ko: "검증자를 누가 운영하는가?" },
          content: {
        ...
        {
          title: { es: "Enmiendas: gobernanza descentralizada", en: "Amendments: decentralized governance", jp: "エンメントメント：分散型ガバナンス", ko: "수정안: 탈중앙화 거버넌스" },
          content: {
        ...
        {
          title: { es: "Midiendo la descentralización", en: "Measuring decentralization", jp: "分散化の測定", ko: "탈중앙화 측정" },
          content: {
