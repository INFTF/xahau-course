...
issueTokens();`,
      ...
      slides: [
        {
          title: { es: "Modelo de tokens en Xahau", en: "Token model in Xahau", jp: "Xahauのトークンモデル", ko: "Xahau의 토큰 모델", zh: "Xahau 的代币模型" },
          content: {
        ...
        {
          title: { es: "TrustLine = Opt-in", en: "TrustLine = Opt-in", jp: "TrustLine = オプトイン", ko: "TrustLine = Opt-in", zh: "TrustLine = 主动加入" },
          content: {
        ...
        {
          title: { es: "Sistema de reservas", en: "Reserve system", jp: "リザーブシステム", ko: "Reserve 시스템", zh: "储备机制" },
          content: {
...
createAndDistributeToken();`,
      ...
      slides: [
        {
          title: { es: "Proceso de creación de un token", en: "Token creation process", jp: "トークン作成プロセス", ko: "토큰 생성 과정", zh: "代币创建流程" },
          content: {
        ...
        {
          title: { es: "Dos cuentas: emisor + reserva", en: "Two accounts: issuer + reserve", jp: "2つのアカウント：発行者 + リザーブ", ko: "두 개의 계정: 발행자 + reserve", zh: "两个账户：发行方 + 储备账户" },
          content: {
        ...
        {
          title: { es: "Resumen de transacciones", en: "Transaction summary", jp: "トランザクションまとめ", ko: "트랜잭션 요약", zh: "交易总结" },
          content: {
...
getTokenBalances("rYourAddressHere");`,
      ...
      slides: [
        {
          title: { es: "Consultar tokens", en: "Query tokens", jp: "トークンの照会", ko: "토큰 조회", zh: "查询代币" },
          content: {
        ...
        {
          title: { es: "DefaultRipple", en: "DefaultRipple", jp: "DefaultRipple", ko: "DefaultRipple", zh: "DefaultRipple" },
          content: {
        ...
        {
          title: { es: "Flags importantes para emisores", en: "Important flags for issuers", jp: "発行者の重要なフラグ", ko: "발행자를 위한 중요한 플래그", zh: "发行方的重要标志" },
          content: {
...
cancelOffer();`,
      ...
      slides: [
        {
          title: { es: "DEX nativo de Xahau", en: "Xahau native DEX", jp: "XahauネイティブDEX", ko: "Xahau 네이티브 DEX", zh: "Xahau 原生 DEX" },
          content: {
        ...
        {
          title: { es: "OfferCreate: anatomía de una orden", en: "OfferCreate: anatomy of an order", jp: "OfferCreate：注文の構造", ko: "OfferCreate: 주문 구조", zh: "OfferCreate：订单结构" },
          content: {
        ...
        {
          title: { es: "Auto-bridging y order book", en: "Auto-bridging and order book", jp: "オートブリッジングと注文書", ko: "자동 브리징과 오더북", zh: "自动桥接与订单簿" },
          content: {
...
freezeTrustLine();`,
      ...
      slides: [
        {
          title: { es: "Freeze: congelación de tokens", en: "Freeze: token freezing", jp: "Freeze：トークンの凍結", ko: "Freeze: 토큰 동결", zh: "Freeze：代币冻结" },
          content: {
        ...
        {
          title: { es: "Clawback: recuperación forzada", en: "Clawback: forced recovery", jp: "Clawback：強制回収", ko: "Clawback: 강제 회수", zh: "Clawback：强制追回" },
          content: {
        ...
        {
          title: { es: "Transfer fees y RequireAuth", en: "Transfer fees and RequireAuth", jp: "Transfer feesとRequireAuth", ko: "Transfer fees와 RequireAuth", zh: "Transfer fees 与 RequireAuth" },
          content: {
