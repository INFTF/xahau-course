...
getURITokens("rYourAddressHere");`,
      ...
      slides: [
        {
          title: { es: "URITokens en Xahau", en: "URITokens on Xahau", jp: "XahauのURIToken", ko: "Xahau의 URIToken" },
          content: {
        ...
        {
          title: { es: "Operaciones con URITokens", en: "URIToken Operations", jp: "URITokenの操作", ko: "URIToken 작업" },
          content: {
        ...
        {
          title: { es: "URIToken vs ERC-721", en: "URIToken vs ERC-721", jp: "URIToken vs ERC-721", ko: "URIToken vs ERC-721" },
          content: {
...
buyURIToken();`,
      ...
      slides: [
        {
          title: { es: "Flujo de venta", en: "Sale Flow", jp: "売却フロー", ko: "판매 흐름" },
          content: {
        ...
        {
          title: { es: "Transferir y quemar", en: "Transfer and Burn", jp: "転送とバーン", ko: "전송과 소각" },
          content: {
        ...
        {
          title: { es: "Quemar URITokens en detalle", en: "Burning URITokens in Detail", jp: "URITokenのバーンの詳細", ko: "URIToken 소각 상세" },
          content: {
...
- **URI에 민감한 데이터를 넣지 마세요**: 레저의 모든 것은 공개 정보입니다.`,
      ...
      slides: [
        {
          title: { es: "El campo URI: opciones de enlace", en: "The URI Field: Link Options", jp: "URIフィールド：リンクの選択肢", ko: "URI 필드: 링크 옵션" },
          content: {
        ...
        {
          title: { es: "Digest: verificación de integridad", en: "Digest: Integrity Verification", jp: "Digest：整合性検証", ko: "Digest: 무결성 검증" },
          content: {
        ...
        {
          title: { es: "Estándar de metadatos JSON", en: "JSON Metadata Standard", jp: "JSONメタデータ標準", ko: "JSON 메타데이터 표준" },
          content: {
