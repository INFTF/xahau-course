...
int64_t hook(uint32_t reserved) {
    ...
    return 0;
      ...
      slides: [
        {
          title: { es: "Hooks vs Smart Contracts EVM", en: "Hooks vs EVM Smart Contracts", jp: "Hooks vs EVMスマートコントラクト", ko: "Hooks vs EVM 스마트 컨트랙트" },
          content: {
        ...
        {
          title: { es: "Modelo reactivo y funciones", en: "Reactive model and functions", jp: "リアクティブモデルと関数", ko: "반응형 모델과 함수" },
          content: {
        ...
        {
          title: { es: "Datos clave sobre Hooks", en: "Key facts about Hooks", jp: "Hooksの主要な事実", ko: "Hooks 핵심 정보" },
          content: {
...
checkHooks("rTuDireccionAqui");`,
      ...
      slides: [
        {
          title: { es: "SetHook: campos principales", en: "SetHook: main fields", jp: "SetHook：主要フィールド", ko: "SetHook: 주요 필드" },
          content: {
        ...
        {
          title: { es: "4 fases de gestion de un Hook", en: "4 Hook management phases", jp: "Hookの管理4フェーズ", ko: "Hook 관리의 4단계" },
          content: {
        ...
        {
          title: { es: "HookOn y HookCanEmit", en: "HookOn and HookCanEmit", jp: "HookOnとHookCanEmit", ko: "HookOn과 HookCanEmit" },
          content: {
...
int64_t hook(uint32_t reserved) {
    ...
    *((int64_t*)counter_buf) = counter;
    ...
    return 0;
      ...
      slides: [
        {
          title: { es: "Sistema de estado en Hooks", en: "Hook state system", jp: "Hooksのステートシステム", ko: "Hook 상태 시스템" },
          content: {
        ...
        {
          title: { es: "Namespace y aislamiento", en: "Namespace and isolation", jp: "名前空間と分離", ko: "Namespace와 분리" },
          content: {
        ...
        {
          title: { es: "Usos practicos del estado", en: "Practical uses of state", jp: "ステートの実用的な用途", ko: "상태의 실전 활용" },
          content: {
...
int64_t hook(uint32_t reserved)
{
    ...
    return 0;
      ...
      slides: [
        {
          title: { es: "emit() — Transacciones autonomas", en: "emit() — Autonomous transactions", jp: "emit() — 自律的なトランザクション", ko: "emit() — 자율 트랜잭션" },
          content: {
        ...
        {
          title: { es: "Flujo de emision", en: "Emission flow", jp: "Emitのフロー", ko: "Emit 흐름" },
          content: {
        ...
        {
          title: { es: "Casos de uso y limitaciones", en: "Use cases and limitations", jp: "ユースケースと制限事項", ko: "활용 사례와 제한사항" },
          content: {
...
sendParameters();`,
      ...
      slides: [
        {
          title: { es: "hook_param vs otxn_param", en: "hook_param vs otxn_param", jp: "hook_param vs otxn_param", ko: "hook_param vs otxn_param" },
          content: {
        ...
        {
          title: { es: "otxn_param: firma y retornos", en: "otxn_param: signature and return values", jp: "otxn_param：シグネチャと戻り値", ko: "otxn_param: 시그니처와 반환값" },
          content: {
        ...
        {
          title: { es: "Namespace y recursos", en: "Namespace and resources", jp: "Namespaceとリソース", ko: "Namespace와 리소스" },
          content: {
...
int64_t hook(uint32_t reserved)
{
    ...
    return 0;
      ...
      slides: [
        {
          title: { es: "Las tres funciones trace*", en: "The three trace* functions", jp: "3つのtrace*関数", ko: "세 가지 trace* 함수" },
          content: {
        ...
        {
          title: { es: "Donde ver las trazas", en: "Where to see traces", jp: "トレースを確認する場所", ko: "trace를 확인하는 곳" },
          content: {
        ...
        {
          title: { es: "Trucos clave de debugging", en: "Key debugging tips", jp: "デバッグの重要なヒント", ko: "중요한 디버깅 팁" },
          content: {
...
빠르게 학습하고 실험하기에는 Hooks Builder가 가장 쉬운 진입점이지만, 메인넷 운영이나 자동화에는 한계가 있습니다.`,
      ...
      slides: [
        {
          title: { es: "Hooks Builder — Entorno online", en: "Hooks Builder — Online environment", jp: "Hooks Builder — オンライン環境", ko: "Hooks Builder — 온라인 환경" },
          content: {
        ...
        {
          title: { es: "Deploy: cuentas e instalacion", en: "Deploy: accounts and installation", jp: "Deploy：アカウントとインストール", ko: "Deploy: 계정과 설치" },
          content: {
        ...
        {
          title: { es: "Test: verificar tu Hook", en: "Test: verify your Hook", jp: "Test：HookをVerify", ko: "Test: Hook 검증" },
          content: {
...
로컬 환경은 버전 관리, 반복 테스트, 스크립트 자동화, 메인넷 운영 준비에 훨씬 유리합니다.`,
      ...
      slides: [
        {
          title: { es: "hooks-cli — Desarrollo local", en: "hooks-cli — Local development", jp: "hooks-cli — ローカル開発", ko: "hooks-cli — 로컬 개발" },
          content: {
        ...
        {
          title: { es: "Estructura del proyecto", en: "Project structure", jp: "プロジェクト構造", ko: "프로젝트 구조" },
          content: {
        ...
        {
          title: { es: "Despliegue y referencia", en: "Deployment and reference", jp: "デプロイとリファレンス", ko: "배포와 참고자료" },
          content: {
