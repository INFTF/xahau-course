...
finishEscrow("rCreatorAddress", 12345);`,
      ...
      slides: [
        {
          title: { es: "¿Qué es un Escrow?", en: "What is an Escrow?", jp: "エスクローとは？", zh: "什么是 Escrow？" },
          content: {
        ...
        {
          title: { es: "Ciclo de vida del Escrow", en: "Escrow lifecycle", jp: "エスクローのライフサイクル", zh: "Escrow 生命周期" },
          content: {
        ...
        {
          title: { es: "Crypto-condiciones", en: "Crypto-conditions", jp: "暗号条件", zh: "加密条件" },
          content: {
...
cashCheck("YOUR_CHECK_ID_HERE");`,
      ...
      slides: [
        {
          title: { es: "¿Qué es un Check?", en: "What is a Check?", jp: "チェックとは？", zh: "什么是 Check？" },
          content: {
        ...
        {
          title: { es: "Ciclo de vida del Check", en: "Check lifecycle", jp: "チェックのライフサイクル", zh: "Check 生命周期" },
          content: {
        ...
        {
          title: { es: "Check vs Payment vs Escrow", en: "Check vs Payment vs Escrow", jp: "チェック vs 支払い vs エスクロー", zh: "Check vs Payment vs Escrow" },
          content: {
...
paymentsWithTickets();`,
      ...
      slides: [
        {
          title: { es: "¿Qué es un Ticket?", en: "What is a Ticket?", jp: "チケットとは？", zh: "什么是 Ticket？" },
          content: {
        ...
        {
          title: { es: "Casos de uso", en: "Use cases", jp: "ユースケース", zh: "使用场景" },
          content: {
        ...
        {
          title: { es: "Tickets vs Secuencia normal", en: "Tickets vs Normal Sequence", jp: "チケット vs 通常のシーケンス", zh: "Tickets vs 普通序列" },
          content: {
...
claimReward();`,
      ...
      slides: [
        {
          title: { es: "ClaimReward", en: "ClaimReward", jp: "ClaimReward", zh: "ClaimReward" },
          content: {
        ...
        {
          title: { es: "Cómo reclamar", en: "How to claim", jp: "請求方法", zh: "如何领取" },
          content: {
...
invokeHook();`,
      ...
      slides: [
        {
          title: { es: "Invoke", en: "Invoke", jp: "Invoke", zh: "Invoke" },
          content: {
        ...
        {
          title: { es: "Casos de uso de Invoke", en: "Invoke use cases", jp: "Invokeのユースケース", zh: "Invoke 的使用场景" },
          content: {
...
deleteRemark();`,
      ...
      slides: [
        {
          title: { es: "SetRemarks", en: "SetRemarks", jp: "SetRemarks", zh: "SetRemarks" },
          content: {
        ...
        {
          title: { es: "Crear, modificar y eliminar", en: "Create, modify and delete", jp: "作成、変更、削除", zh: "创建、修改和删除" },
          content: {
        ...
        {
          title: { es: "ObjectID: ¿qué objeto anotar?", en: "ObjectID: which object to annotate?", jp: "ObjectID：どのオブジェクトに注釈するか？", zh: "ObjectID：要标注哪个对象？" },
          content: {
...
sendRemit();`,
      ...
      slides: [
        {
          title: { es: "Remit — Transacción multi-función", en: "Remit — Multi-function Transaction", jp: "Remit — マルチ機能トランザクション", zh: "Remit — 多功能交易" },
          content: {
        ...
        {
          title: { es: "Remit paga las reservas", en: "Remit pays the reserves", jp: "Remitはリザーブを支払う", zh: "Remit 支付准备金" },
          content: {
...
deleteCron();`,
      ...
      slides: [
        {
          title: { es: "¿Qué es CronSet?", en: "What is CronSet?", jp: "CronSetとは？", zh: "什么是 CronSet？" },
          content: {
        ...
        {
          title: { es: "Configurar CronSet", en: "Setting up CronSet", jp: "CronSetの設定", zh: "配置 CronSet" },
          content: {
        ...
        {
          title: { es: "Invoke vs CronSet", en: "Invoke vs CronSet", jp: "Invoke vs CronSet", zh: "Invoke vs CronSet" },
          content: {
